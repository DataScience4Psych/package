...
The DS4P R package offers a comprehensive suite of functions tailored for extended behavior genetics analysis, including model identification, calculating relatedness, pedigree conversion, pedigree simulation, and more.
...
print(citation(package = "DS4P"), style = "text", bibtex = FALSE)
```

A BibTeX entry for LaTeX users is
```{r,comment='',echo=FALSE}
toBibtex(citation(package = "DS4P"))
```
